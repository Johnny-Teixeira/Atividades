...
//2. Crie uma função chamada menos. Caso seja passado apenas 1 parâmetro, retorne o valor negativo. Caso sejam passados 2,
//retorne a subtração dos dois.

const menos = function(x, y=(x*2)){
    return x-y;
}
